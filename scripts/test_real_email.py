...
def setup_wizard():
    ...
    print("   - Set EMAIL_ADDRESS to your test Gmail")
    print("   - Set EMAIL_PASSWORD to your app password")
    ...
    try:
        ...
        with reader as r:
            ...
            if newsletters:
                ...
                print("   ⚠️  No newsletters found. Consider subscribing to some for testing.")
